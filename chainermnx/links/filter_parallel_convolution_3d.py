...
class FilterParallelConvolution3D(chainer.links.Convolution3D):
    def __init__(self, comm, in_channels, out_channels, *args, **kwargs):
        ...
        super(FilterParallelConvolution3D, self).__init__(self.in_channels, self.new_filters, *args, **kwargs)

    def __call__(self, x):
        y = super(FilterParallelConvolution3D, self).__call__(x)
