...
def deconvolution_2d(comm, index, x, W, b=None, stride=1, pad=0, outsize=None, **kwargs):
...
http://www.matthewzeiler.com/pubs/cvpr2010/cvpr2010.pdf
    ...
    Deconvolution links can use a feature of cuDNN called autotunintype of x in DECONVg, which
...
astype(np.float32)
    ...
    func = Deconvolution2DFunction(comm, index, stride, pad, outsize, dilate=dilate,
                                   groups=groups)
